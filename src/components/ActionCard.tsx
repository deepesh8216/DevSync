...
function ActionCard({ action, onClick }: { action: QuickActionType; onClick: () => void }) {
  return (
    <div className="p-2 rounded-xl shadow-lg bg-white/10 backdrop-blur-md border border-white/20">
    <Card
    ...
    >
      {/* ACTION GRADIENT */}
      <div 
        className={`absolute inset-0 bg-gradient-to-br ${action.gradient} opacity-100 group-hover:opacity-30 transition-opacity`}
      />
